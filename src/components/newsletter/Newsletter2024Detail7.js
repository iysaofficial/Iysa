...
const Newsletter2024Detail7 = () => {
    const dataItems = DataLetter.NewsletterJuly2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail7";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage7", newsletterTitle);
...
export default Newsletter2024Detail7;
