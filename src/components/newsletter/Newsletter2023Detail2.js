...
const Newsletter2023Detail2 = () => {
    const dataItems = DataLetter.NewsletterFebruary2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail2";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage2", newsletterTitle);
