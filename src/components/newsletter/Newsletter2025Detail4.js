...
const Newsletter2025Detail4 = () => {
    const dataItems = DataLetter.NewsletterApril2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail4";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage4", newsletterTitle);
...
export default Newsletter2025Detail4;
