...
const Newsletter2023Detail4 = () => {
    const dataItems = DataLetter.NewsletterApril2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail4";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage4", newsletterTitle);
