...
const Newsletter2023Detail15 = () => {
    const dataItems = DataLetter.NewsletterNovember2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail15";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage15", newsletterTitle);
