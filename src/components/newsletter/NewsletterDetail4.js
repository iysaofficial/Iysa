...
const NewsletterDetail4 = () => {
    const dataItems = DataLetter.NewsletterApril2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail4";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage4", newsletterTitle);
