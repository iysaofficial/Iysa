...
const NewsletterDetail1 = () => {
    const dataItems = DataLetter.NewsletterJanuary2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail1";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage1", newsletterTitle);
