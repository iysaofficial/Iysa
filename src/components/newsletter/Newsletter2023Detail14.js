...
const Newsletter2023Detail14 = () => {
    const dataItems = DataLetter.NewsletterOctober2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail14";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage14", newsletterTitle);
