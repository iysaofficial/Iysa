...
const Newsletter2023Detail1 = () => {
    const dataItems = DataLetter.NewsletterJanuary2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail1";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage1", newsletterTitle);
