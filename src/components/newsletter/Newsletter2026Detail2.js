...
const Newsletter2026Detail2 = () => {
    const dataItems = DataLetter.NewsletterBatch2Edition2026;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2026Detail2";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2026DetailPage2", newsletterTitle);
