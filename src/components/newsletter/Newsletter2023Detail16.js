...
const Newsletter2023Detail16 = () => {
    const dataItems = DataLetter.NewsletterDecember2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail16";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage16", newsletterTitle);
