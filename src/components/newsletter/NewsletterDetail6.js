...
const NewsletterDetail6 = () => {
    const dataItems = DataLetter.NewsletterJune2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail6";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage6", newsletterTitle);
