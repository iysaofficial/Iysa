...
const Newsletter2023Detail8 = () => {
    const dataItems = DataLetter.NewsletterAugust2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail8";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage8", newsletterTitle);
