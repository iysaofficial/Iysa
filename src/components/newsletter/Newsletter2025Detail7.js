...
const Newsletter2025Detail7 = () => {
    const dataItems = DataLetter.NewsletterBatch1Edition2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail7";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage7", newsletterTitle);
...
export default Newsletter2025Detail7;
