...
const NewsletterDetail9 = () => {
    const dataItems = DataLetter.NewsletterSeptember2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail9";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage9", newsletterTitle);
