...
const NewsletterDetail7 = () => {
    const dataItems = DataLetter.NewsletterJuly2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail7";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage7", newsletterTitle);
