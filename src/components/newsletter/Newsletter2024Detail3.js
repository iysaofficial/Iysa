...
const Newsletter2024Detail3 = () => {
    const dataItems = DataLetter.NewsletterMaret2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail3";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage3", newsletterTitle);
...
export default Newsletter2024Detail3;
