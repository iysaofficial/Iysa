...
const Newsletter2024Detail4 = () => {
    const dataItems = DataLetter.NewsletterApril2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail4";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage4", newsletterTitle);
...
export default Newsletter2024Detail4;
