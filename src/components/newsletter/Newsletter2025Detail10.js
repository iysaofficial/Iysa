...
const Newsletter2025Detail10 = () => {
    const dataItems = DataLetter.NewsletterBatch4Edition2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail10";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage10", newsletterTitle);
...
export default Newsletter2025Detail10;
