...
const Newsletter2025Detail3 = () => {
    const dataItems = DataLetter.NewsletterMarch2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail3";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage3", newsletterTitle);
...
export default Newsletter2025Detail3;
