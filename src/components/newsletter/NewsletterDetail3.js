...
const NewsletterDetail3 = () => {
    const dataItems = DataLetter.NewsletterMaret2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail3";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage3", newsletterTitle);
