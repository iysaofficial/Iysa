...
const NewsletterDetail11 = () => {
    const dataItems = DataLetter.NewsletterNovember2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail11";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage11", newsletterTitle);
