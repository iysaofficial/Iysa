...
const NewsletterDetail10 = () => {
    const dataItems = DataLetter.NewsletterOctober2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail10";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage10", newsletterTitle);
