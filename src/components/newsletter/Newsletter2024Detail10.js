...
const Newsletter2024Detail10 = () => {
    const dataItems = DataLetter.NewsletterOctober2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail10";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage10", newsletterTitle);
...
export default Newsletter2024Detail10;
