...
const Newsletter2023Detail3 = () => {
    const dataItems = DataLetter.NewsletterMaret2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail3";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage3", newsletterTitle);
