...
const Newsletter2025Detail1 = () => {
    const dataItems = DataLetter.NewsletterJanuary2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail1";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage1", newsletterTitle);
...
export default Newsletter2025Detail1;
