...
const Newsletter2025Detail9 = () => {
    const dataItems = DataLetter.NewsletterBatch3Edition2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail9";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage9", newsletterTitle);
...
export default Newsletter2025Detail9;
