...
const Newsletter2023Detail7 = () => {
    const dataItems = DataLetter.NewsletterJuly2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail7";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage7", newsletterTitle);
