...
const NewsletterDetail2 = () => {
    const dataItems = DataLetter.NewsletterFebruary2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail2";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage2", newsletterTitle);
