...
const Newsletter2024Detail5 = () => {
    const dataItems = DataLetter.NewsletterMay2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail5";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage5", newsletterTitle);
...
export default Newsletter2024Detail5;
