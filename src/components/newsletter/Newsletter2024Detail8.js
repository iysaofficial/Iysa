...
const Newsletter2024Detail8 = () => {
    const dataItems = DataLetter.NewsletterAgustus2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail8";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage8", newsletterTitle);
...
export default Newsletter2024Detail8;
