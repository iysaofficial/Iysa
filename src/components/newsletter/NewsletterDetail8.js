...
const NewsletterDetail8 = () => {
    const dataItems = DataLetter.NewsletterAugust2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail8";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage8", newsletterTitle);
