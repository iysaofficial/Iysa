...
const NewsletterDetail5 = () => {
    const dataItems = DataLetter.NewsletterMei2022;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "NewsletterDetail5";
    const { viewCount, lastViewed } = useNewsletterTracker("/NewsletterDetailPage5", newsletterTitle);
