...
const Newsletter2024Detail11 = () => {
    const dataItems = DataLetter.NewsletterNovember2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail11";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage11", newsletterTitle);
...
export default Newsletter2024Detail11;
