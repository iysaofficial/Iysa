...
const Newsletter2024Detail1 = () => {
    const dataItems = DataLetter.NewsletterJanuary2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail1";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage1", newsletterTitle);
