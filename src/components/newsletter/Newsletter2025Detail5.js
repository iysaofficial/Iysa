...
const Newsletter2025Detail5 = () => {
    const dataItems = DataLetter.NewsletterMay2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail5";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage5", newsletterTitle);
...
export default Newsletter2025Detail5;
