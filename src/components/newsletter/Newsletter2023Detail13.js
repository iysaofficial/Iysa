...
const Newsletter2023Detail13 = () => {
    const dataItems = DataLetter.NewsletterSeptember2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail13";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage13", newsletterTitle);
