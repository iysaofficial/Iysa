...
const Newsletter2024Detail12 = () => {
    const dataItems = DataLetter.NewsletterDecember2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail12";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage12", newsletterTitle);
...
export default Newsletter2024Detail12;
