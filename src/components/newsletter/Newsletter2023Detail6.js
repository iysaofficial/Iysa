...
const Newsletter2023Detail6 = () => {
    const dataItems = DataLetter.NewsletterJune2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail6";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage6", newsletterTitle);
