...
const Newsletter2025Detail2 = () => {
    const dataItems = DataLetter.NewsletterFebruary2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail2";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage2", newsletterTitle);
...
export default Newsletter2025Detail2;
