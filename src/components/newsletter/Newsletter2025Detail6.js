...
const Newsletter2025Detail6 = () => {
    const dataItems = DataLetter.NewsletterJuni2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail6";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage6", newsletterTitle);
...
export default Newsletter2025Detail6;
