...
const Newsletter2024Detail9 = () => {
    const dataItems = DataLetter.NewsletterSeptember2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail9";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage9", newsletterTitle);
...
export default Newsletter2024Detail9;
