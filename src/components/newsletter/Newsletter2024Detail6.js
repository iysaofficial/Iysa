...
const Newsletter2024Detail6 = () => {
    const dataItems = DataLetter.NewsletterJune2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detail6";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage6", newsletterTitle);
...
export default Newsletter2024Detail6;
