...
const Newsletter2026Detail1 = () => {
    const dataItems = DataLetter.NewsletterBatch1Edition2026;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2026Detail1";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2026DetailPage1", newsletterTitle);
...
export default Newsletter2026Detail1;
