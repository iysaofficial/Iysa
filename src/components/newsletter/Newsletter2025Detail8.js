...
const Newsletter2025Detail8 = () => {
    const dataItems = DataLetter.NewsletterBatch2Edition2025;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2025Detail8";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2025DetailPage8", newsletterTitle);
...
export default Newsletter2025Detail8;
