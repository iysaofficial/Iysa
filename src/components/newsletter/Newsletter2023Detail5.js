...
const Newsletter2023Detail5 = () => {
    const dataItems = DataLetter.NewsletterMei2023;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2023Detail5";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2023DetailPage5", newsletterTitle);
