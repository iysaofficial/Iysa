...
const Newsletter2024Detaile2 = () => {
    const dataItems = DataLetter.NewsletterFebruary2024;
    const newsletterTitle = dataItems && dataItems.length > 0 ? dataItems[0].title : "Newsletter2024Detaile2";
    const { viewCount, lastViewed } = useNewsletterTracker("/Newsletter2024DetailPage2", newsletterTitle);
...
export default Newsletter2024Detaile2;
