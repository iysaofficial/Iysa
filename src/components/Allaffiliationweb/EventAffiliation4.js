      ...
      <section className="position-relative">
        <div>
          <img
            ...
            src="./assets/images/logo afiliasi/inventcore.png"
          />
          <br></br>
          <h3 className="text-center fw-bold">
            5th International Exhibition InventCor
          </h3>
          <p className="mt-5 fs-5 text-center px-4">
            Inventcor adalah salah satu event afiliasi IYSA yang berasal dari
            Romania. Event ini cukup bergengsi dengan membahas berbagai topik:
            sains, inovasi, ekologi, keamanan, kesehatan, komunitas, kekayaan
            intelektual, metode pengajaran, kewirausahaan, seni dan lain-lain..
          </p>
          <br />
...
export default EventAffiliation4;
