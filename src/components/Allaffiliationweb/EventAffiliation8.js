      ...
      <section className="position-relative">
        <div>
          ...
          <p className="mt-5 fs-5 text-center px-4">
            The Africa Science Buskers Festival (ASBF) is Africa's leading
            science fair for young scientists, engineers, artists and science
            communicators in primary and secondary schools. In ASBF 2024,
            participants will present and perform a “show-and-tell” on any
            chosen science topic, innovation or original research.
          </p>
          <br />
...
export default EventAffiliation8;
