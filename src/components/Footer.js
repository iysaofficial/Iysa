        ...
        <footer>
            <div className='rowFooter'>
                ...
                <div className='colFooter'>
                    ...
                    <a href='https://goo.gl/maps/9x18coXGCmSscKec6' target="_blank" rel="noreferrer"  className='office text-justify'>Jl. Kemang, Pasir Putih, Kecamatan. Sawangan, Kota Depok, Jawa Barat 16519</a>
                    <br></br><br></br>
                ...
                <div className='colFooter'>
                    ...
                    <div className='social-icons'>
                        <a href='https://www.facebook.com/profile.php?id=100063979907207' target="_blank" rel="noreferrer" ><i className=''><FontAwesomeIcon icon={faFacebookF} className='footer-social-icons-fb'></FontAwesomeIcon></i></a>
                        <a href='https://www.instagram.com/iysa_official/?hl=id' target="_blank" rel="noreferrer" ><i className=''><FontAwesomeIcon icon={faInstagram} className='footer-social-icons-ig'></FontAwesomeIcon></i></a>
                        <a href='https://www.youtube.com/@IYSAOfficial' target="_blank" rel="noreferrer" ><i className=''><FontAwesomeIcon icon={faYoutube} className='footer-social-icons-yt'></FontAwesomeIcon></i></a>
                        <a href='https://www.tiktok.com/@iysa.official' target="_blank" rel="noreferrer" ><i><FontAwesomeIcon icon={faTiktok} className='footer-social-icons-tt' /></i></a>
                        <a href='https://www.linkedin.com/company/indonesian-young-scientist-association-iysa' target="_blank" rel="noreferrer" ><i><FontAwesomeIcon icon={faLinkedin} className='footer-social-icons-ld' /></i></a>
                    </div>
                </div>
            </div>
