    ...
    <section>
      <div id="main-event" className="container">
        <div className="row event-wrapper ">
          {EventPosterDetail.event23.map((EventPosterDetail23) => {
            return (
              <section>
                ...
                <div className="main-colom row col-12 mt-5 mb-5">
                  <div className="colom-left col-md-8  mt-2">
                    ...
                    <a
                      ...
                      href={EventPosterDetail23.LinkRegist}
                      target="-blank"
                    >
                      Registration Here
                    </a>
                  ...
                  <div className="colom-right col-md-4 text-center text-md-start ">
                    ...
                    <p>{EventPosterDetail23.DateAdTime}</p>
                    <br />
                    <h4 className="fw-bolder">Registration End Date</h4>
                    <p>{EventPosterDetail23.RegistEndDate}</p>
                    <br />
                    <h4 className="fw-bolder">Location</h4>
                    <p>{EventPosterDetail23.Location}</p>
                    <br />
                    <h4 className="fw-bolder">Event Types</h4>
                    <p>{EventPosterDetail23.EventType}</p>
                    <br />
                    <h4 className="fw-bolder">Event Category</h4>
                    <p>{EventPosterDetail23.EventCategory}</p>
                    <br />
                      ...
                      <div className="row event-venue">
                        ...
                        <div className="event-venue-right col-8 mt-auto mb-auto">
                          <a
                            ...
                            href={EventPosterDetail23.LinkGmaps}
                            target="-blink"
                          >
                            <FontAwesomeIcon
                              icon={faLocationDot}
                              style={{ color: "#1164e8" }}
                            />
                            {EventPosterDetail23.NameLocation}
                          </a>
                          <br />
                        </div>
                      </div>
